...
This file contains the following functions:
    ...
    * find_complete_list_anno_only - Finds annotations for all pairs of 
    repeats found in find_al_repeats. This list contains all the pairs of  
    ...
    * find_add_erows - Finds pairs of repeated structures, representated as 
    ...
    * find_add_srows - Finds pairs of repeated structures, representated as 
...
def find_complete_list_anno_only(pair_list, song_length):
    """
    Finds annotations for all pairs of repeats found in find_al_repeats. This 
