...
def find_complete_list(pair_lst,song_length):
   ...
   pair_lst: np.array
    ...
    for i in range (1, b+1):
        ...
        add_erows = find_add_mrows_both_check_no_anno(pair_lst, int_snds, bw)
        add_mrows = find_add_erows_both_check_no_anno(pair_lst, int_ends, bw) # This function returns an empty array
        ...
        add_mat = np.concatenate((add_mat,add_srows,add_erows,add_mrows), axis=0)
